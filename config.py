...
class ProgressiveConfig:
    ...
    STAGES = {
        ...
        "tiny_imagenet": {
            ...
            "weight_decay": 1e-3,
            "label_smoothing": 0.1,
            "description": "Medium complexity training - reduced LR to prevent overfitting",
            "enabled": True,
            "priority": 2
        },
        "imagenet_mini": {
        ...
        "imagenet": {
            ...
            "weight_decay": 1e-3,
            "label_smoothing": 0.1,
            "description": "Final full-scale training with One Cycle LR - standard ImageNet settings",
            "enabled": True,
            "priority": 4
        }
    }
